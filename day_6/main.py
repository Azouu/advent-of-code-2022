...
def get_nb_characters_before_marker_is_complete(datastream_buffer_input: str, offset: int) -> int:
...
def first_part(datastream_buffer_input: str) -> int:
    return get_nb_characters_before_marker_is_complete(datastream_buffer_input, offset=4)


def second_part(datastream_buffer_input: str) -> int:
    return get_nb_characters_before_marker_is_complete(datastream_buffer_input, offset=14)
